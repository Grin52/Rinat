...
Необходимо вычислить первые n членов арифметической прогрессии и вывести их по порядку в одну строчку через пробел. 
...
int main(void)
{
    ...
    for (a1; n < )// здесь продолжайте программу
